...
namespace DBFirst_EF.Controllers
{
    public class RegionsController : Controller
    {
        ...
        public RegionsController(NORTHWNDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Regions != null ? 
                          ...
                          Problem("Entity set 'NORTHWNDContext.Regions'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NORTHWNDContext.Regions'  is null.");
            }
            var region = await _context.Regions.FindAsync(id);
            if (region != null)
            {
